...
const ICON_HEART = `<span class="icon-heart-fill"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" aria-hidden="true"><path d="M10 17.5s-6.5-3.7-6.5-9.2C3.5 5.6 5.6 4 7.6 4c1.4 0 2.3.7 2.4 1.7C10.1 4.7 11 4 12.4 4c2 0 4.1 1.6 4.1 4.3 0 5.5-6.5 9.2-6.5 9.2z"/></svg></span>`;
